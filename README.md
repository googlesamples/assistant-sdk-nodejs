...
1. Install the [`google-oauthlib-tool`][google-oauthlib-tool] in a [Python 3][python3] virtual environment:
...
```
1. Use the [`google-oauthlib-tool`][google-oauthlib-tool] to generate credentials:
